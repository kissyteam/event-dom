 ...
 * @param {Object} cfg
 * @private
 * @class Event.DomEvent.Observable
...
util.extend(DomEventObservable, BaseEvent.Observable, {
     ...
     * @param {Event.DomEvent.Object} event
     ...
     * @param {Object|Event.DomEvent.Object} [event] additional event data
     ...
     * @param {Object} cfg {@link Event.DomEvent.Observer} 's config
     */
    on: function (cfg) {
        var self = this,
            observers = self.observers,
 ...
 * @return {Event.DomEvent.Observable}
 */
